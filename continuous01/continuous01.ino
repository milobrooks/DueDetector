...
void loop(void)
{
  ...
  Serial.println(results); //Serial.print("("); Serial.print(ads.computeVolts(results)); Serial.println("V)");


  // In a real application we probablynew_data = false;
  // we don't want to do a delay here if we are doing interrupt-based sampling, but we have a delay
